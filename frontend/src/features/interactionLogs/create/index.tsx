...
import CreateInteractionForm from "./form";
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="space-y-1">
            ...
            <p className="max-w-2xl text-sm text-gray-600 dark:text-zinc-400">
              Add a new interaction and link it to one of your existing clients
              and projects. Fill in the interaction details carefully so you can
              track deadlines, budgets, and progress from your dashboard.
            </p>
          </div>
        </div>
      </div>
...
export default CreateInteractionLog;
